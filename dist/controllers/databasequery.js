...
exports.getfriendlastlogin = function (friendid, userid) {
    return "select c.lasttimelogin FROM users c, friend_relates f WHERE c.userid = '"
...
exports.getGroupConversation = function (groupid, userid) {
    return "select distinct a.unhide_usermindid, a.userid, a.message_data, a.datetime_unhide, a.username, u.datetime_read, u.readerid FROM (select c.unhide_usermindid, c.userid, c.message_data, c.datetime_unhide, usr.username "
...
exports.getFriendConversation = function (friendid, userid) {
    return "select c.unhide_usermindid, c.userid, c.message_data, c.datetime_unhide, usr.username, usr.lasttimelogin, s.receiverid, s.datetime_tell, s.datetime_read "
...
exports.getfriendchatsUnreadMessagedata = function (friendid, userid) {
    return "select c.unhide_usermindid, c.userid, c.message_data, c.datetime_unhide, usr.username "
...
exports.getgroupchatsUnreadmessagedata = function (groupid, userid) {
    return "select c.unhide_usermindid, c.userid, c.message_data, c.datetime_unhide, usr.username "
...
exports.getFriendnotify = function (userid) {
    return "select COUNT (c.userid) AS 'totalnoticecount', c.userid FROM unhide_userminds c, say_to_friends s, users usr "
...
exports.getGroupnotify = function (userid) {
    return "select COUNT (u.groupid) AS 'totalnoticecount', u.groupid FROM unhide_userminds c, unread_groups u, users usr "
...
exports.getGroupInfomation = function (groupid) {
    return "select cg.groupid, cg.group_name, cg.creator, usr.userid, usr.username, usr.lasttimelogin FROM chat_groups cg, member_of_chat_groups m, users usr "
        + " WHERE cg.groupid = m.groupid AND m.userid = usr.userid AND cg.groupid = '" + groupid + "'";
};
exports.getFriendInfomation = function (friendid, userid) {
    return "select usr.userid, usr.username, usr.lasttimelogin FROM users usr, friend_relates f "
...
exports.unhide_yourmind = function (userid, messageData, datetimeUnhide) {
    return "INSERT INTO unhide_userminds (userid, message_data, datetime_unhide) value"
        + " ('" + userid + "', '" + messageData + "', '" + datetimeUnhide + "') ;";
};
exports.say_to_group = function (userid, unhideUsermindid, groupid, datetimeTell) {
    return "INSERT INTO say_to_groups (tellerid, unhide_usermindid, groupid, datetime_tell) value"
        + " ('" + userid + "', '" + unhideUsermindid + "', '" + groupid + "', '" + datetimeTell + "') ;";
};
exports.say_to_friend = function (receiverid, unhideUsermindid, datetimeTell) {
    return "INSERT INTO say_to_friends (receiverid, unhide_usermindid, datetime_tell) value"
        + " ('" + receiverid + "', '" + unhideUsermindid + "', '" + datetimeTell + "') ;";
};
exports.insert_unread_group = function (readerid, unhideUsermindid, groupid) {
    return "INSERT INTO unread_groups (readerid, unhide_usermindid, groupid) value"
        + " ('" + readerid + "', '" + unhideUsermindid + "', '" + groupid + "') ;";
};
exports.update_unread_friend = function (readerid, unhideUsermindid, datetimeRead) {
    return "UPDATE say_to_friends set datetime_read = '"
        + datetimeRead + "' WHERE receiverid = '" + readerid + "' AND unhide_usermindid = '" + unhideUsermindid + "'";
};
exports.update_unread_group = function (readerid, unhideUsermindid, datetimeRead) {
    return "UPDATE unread_groups set datetime_read = '"
        + datetimeRead + "' WHERE readerid = '" + readerid + "' AND unhide_usermindid = '" + unhideUsermindid + "'";
};
exports.get_group_member = function (groupid, userid) {
    return "select usr.userid, usr.username FROM member_of_chat_groups m, users usr "
